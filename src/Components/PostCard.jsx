...
const PostCard = () => {
    ...
    return (
        ...
        <div className='shadow-lg w-72 rounded-md m-20 ml-32 bg-white dark:bg-black dark:shadow-white'>
            <div className='flex justify-center'>
                <div className='font-bold text-xl p-3 dark:text-white'>
                    <h1>Galapagos Islands, Ecuador</h1>
                </div>
                <div className='flex text-gray-300 hover:text-black cursor-pointer p-2'onClick={() => setCommentOpen(!commentOpen)}>
